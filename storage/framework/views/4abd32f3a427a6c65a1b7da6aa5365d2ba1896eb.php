...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="<?php echo e(url('bootstrap/dist/css/bootstrap.min.css')); ?>">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo e(url('assets/font-awesome/css/font-awesome.min.css')); ?>">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo e(url('assets/Ionicons/css/ionicons.min.css')); ?>">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(url('assets/css/AdminLTE.min.css')); ?>">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo e(url('assets/css/_all-skins.min.css')); ?>">
...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="/user/image/<?php echo e(Auth::user()->image); ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo e(Auth::user()->name); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="/user/image/<?php echo e(Auth::user()->image); ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo e(Auth::user()->name); ?> - Web Developer
                  <small>Member since <?php echo e(date('d F Y', strtotime(Auth::user()->created_at))); ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <button style="cursor:pointer;" class="btn btn-default btn-flat" type="button" onclick="window.location.href='<?php echo e(route('logout')); ?>';event.preventDefault();
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php if(Auth::user()->minat == NULL): ?>
      <div class="alert alert-warning alert-dismissible">
        <h4><i class="icon fa fa-warning"></i> Alert!</h4>
        Please complete your profile, click this link. <a href="/user/profile/<?php echo e(Auth::user()->id); ?>/edit">Click</a>
      </div>
      <?php else: ?>
      <div class="alert alert-warning alert-dismissible" style="display:none;">
        <h4><i class="icon fa fa-warning"></i> Alert!</h4>
        Please complete your profile, click this link. <a href="">Click</a>
      </div>
      <?php endif; ?>
      <div class="row">
...
<!-- jQuery 3 -->
<script src="<?php echo e(url('assets/jquery/dist/jquery.min.js')); ?>"></script>
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo e(url('bootstrap/dist/js/bootstrap.min.js')); ?>"></script>
<!-- SlimScroll -->
<script src="<?php echo e(url('assets/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(url('assets/fastclick/lib/fastclick.js')); ?>"></script>
<!-- AdminLTE App -->
...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="<?php echo e(url('admin/bootstrap/css/bootstrap.css')); ?>" rel="stylesheet">

    <!-- Waves Effect Css -->
    <link href="<?php echo e(url('assets/node-waves/waves.css')); ?>" rel="stylesheet" />

    <!-- Animation Css -->
    <link href="<?php echo e(url('assets/animate-css/animate.css')); ?>" rel="stylesheet" />
...
<body class="theme-red">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a onclick="window.location.href='<?php echo e(route('logout')); ?>';event.preventDefault();
    ...
    <!-- Jquery Core Js -->
    <script src="<?php echo e(url('admin/jquery/jquery.min.js')); ?>"></script>

    <!-- Bootstrap Core Js -->
    <script src="<?php echo e(url('admin/bootstrap/js/bootstrap.js')); ?>"></script>

    <!-- Select Plugin Js -->
    <script src="<?php echo e(url('assets/bootstrap-select/js/bootstrap-select.js')); ?>"></script>

    <!-- Slimscroll Plugin Js -->
    <script src="<?php echo e(url('assets/jquery-slimscroll/jquery.slimscroll.js')); ?>"></script>

    <!-- Waves Effect Plugin Js -->
    <script src="<?php echo e(url('assets/node-waves/waves.js')); ?>"></script>

    <!-- Custom Js -->
    <script src="<?php echo e(url('assets/js/admin.js')); ?>"></script>

    <!-- Demo Js -->
    <script src="<?php echo e(url('assets/js/admindem.js')); ?>"></script>
</body>
