...
<br></p>
    ...
    <div class="form-container" id="signup" style="display:none;">
        <div class="media-container-column">
            ...
            <form class="mbr-form" action="<?php echo e(route('register')); ?>" method="post" data-form-title="Mobirise Form"><input type="hidden" data-form-email="true" value="PbNnO3bwjzk1r3Bi7uCghCn/JjsWECW+JW0MKhJCs2yoiwNSC3TTyWNXmYBRgfFEfKB1IeYqm9OotLzETfNnDlQwGGZXCVKgMBjv1/gfbXzQW0Sv8eBMidYfT8pSDfiR">
              <?php echo e(csrf_field()); ?>

                <div data-for="name">
                    <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                        <input id="name" type="text" class="form-control" placeholder="Username" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                        <?php if($errors->has('name')): ?>
                            <div class="align-center" style="color:white;font-weight: bold;background-color:red;font-size:15px;margin-top:5px;border-radius:5px;"><?php echo e($errors->first('name')); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                <div data-for="email">
                    <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                      ...
                      <?php if($errors->has('email')): ?>
                            <div class="align-center" style="color:white;font-weight: bold;background-color:red;font-size:15px;margin-top:5px;border-radius:5px;"><?php echo e($errors->first('email')); ?></div>
                      <?php endif; ?>
                    </div>
                </div>
                <div data-for="password">
                    <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                      ...
                      <?php if($errors->has('password')): ?>
                          <div class="align-center" style="color:white;font-weight: bold;background-color:red;font-size:15px;margin-top:5px;border-radius:5px;"><?php echo e($errors->first('password')); ?></div>
                      <?php endif; ?>
                    </div>
                </div>
                <div data-for="password">
    ...
    <div class="form-container" id="signin">
        <div class="media-container-column">
          ...
          <?php endif; ?>
            <form class="mbr-form" role="form" method="POST" action="<?php echo e(route('login')); ?>">
              <?php echo e(csrf_field()); ?>

                <div data-for="email">
                    <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                        <input id="email" type="email" class="form-control" placeholder="Your Email" name="email" value="<?php echo e(old('email')); ?>" required autofocus>
                        <?php if($errors->has('email')): ?>
                        <div class="align-center" style="color:white;font-weight: bold;background-color:red;font-size:15px;margin-top:5px;border-radius:5px;"><?php echo e($errors->first('email')); ?></div>
                        <?php endif; ?>
                    </div>
