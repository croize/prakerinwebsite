...
<div id="post_event" class="container-fluid">
  <?php $__currentLoopData = $userevent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="media-container-row">
                ...
                <div class="media-content">
                    <div class="mbr-section-text">
                          <p class="mbr-text mb-0 mbr-fonts-style display-7"><a href="event/<?php echo e($event->id); ?>"><?php echo e($event->title); ?></a><br>
                        <i>Oleh : </i><?php echo e($event->penyelenggara); ?></p>
                        <p class="mbr-text mb-0 mbr-fonts-style display-7"><?php echo e($event->desc_pembuka); ?></p>
                    </div>
                </div>
                <div class="media-content">
                    <div class="mbr-section-text">
                        <p class="mbr-text mb-0 mbr-fonts-style display-7">
                         <span class="glyphicon glyphicon-user" aria-hidden="true"></span> : <?php echo e($event->peserta); ?> Peserta<br>
                          <span class="glyphicon glyphicon glyphicon-calendar"></span> : <?php echo e($event->date); ?><br>
                          <span class="glyphicon glyphicon-time"></span> : <?php echo e($event->time); ?><br>
                          <span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> : <?php echo e($event->point); ?><br>
                    </div>
                </div>
            </div>
            </section>
