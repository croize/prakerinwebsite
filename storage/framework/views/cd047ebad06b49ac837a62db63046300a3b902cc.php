            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                <div class="plan-header text-center pt-5">
                    ...
                    <div class="plan-price">
                        <span class="price-value mbr-fonts-style display-1"><?php echo e($tung); ?></span>
                ...
                <div class="plan-body">
                    ...
                    <div class="plan-list align-center">
                      ...
                      <form action="/as/<?php echo e($cit); ?>" method="post">
                        <?php echo e(csrf_field()); ?>
            ...
            <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <form id="demo-form" data-parsley-validate action="<?php echo e(route('login')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>
                  ...
                  <div class="modal-body">
                    ...
                    <?php endif; ?>
                      ...
                      <label for="fullname" class="<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">Email * :</label>
                      ...
                      <label for="password" class="<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">Password * :</label>
