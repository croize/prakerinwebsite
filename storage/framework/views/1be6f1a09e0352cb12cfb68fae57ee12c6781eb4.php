...
<head>
  ...
  <title>Page 2</title>
  <link rel="stylesheet" href="<?php echo e(url('assets/web/assets/mobirise-icons/mobirise-icons.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/tether/tether.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/bootstrap/css/bootstrap.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/bootstrap/css/bootstrap-grid.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/bootstrap/css/bootstrap-reboot.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/dropdown/css/style.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/socicon/css/styles.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/theme/css/style.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(url('assets/mobirise/css/mbr-additional.css')); ?>" type="text/css">
  <link rel="stylesheet" href="<?php echo e(url('assets/css/gypyicon-bootlize.css')); ?>">
...
<body>
  ...
  <script src="<?php echo e(url('assets/web/assets/jquery/jquery.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/popper/popper.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/tether/tether.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/bootstrap/js/bootstrap.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/smooth-scroll/smooth-scroll.js')); ?>"></script>
  <script src="<?php echo e(url('assets/dropdown/js/script.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/touch-swipe/jquery.touch-swipe.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/theme/js/script.js')); ?>"></script>
