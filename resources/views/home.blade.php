    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="media-content px-3 align-self-center mbr-white py-2">
                    <p class="mbr-text testimonial-text mbr-fonts-style display-1"><span style="font-style: normal;"><strong>&nbsp; &nbsp;{{ Auth::user()->name }}</strong></span></p>
                          ...
                          <div class="quick-stats__info">
                            <div class="row">
                              <div class="col-md-6 col-sm-6">
                                <b style="font-size:50px;color:white;">{{$jmluser}}</b>
                              </div>
                              <div class="col-md-6 col-sm-6">
                  ...
                  <div class="col-sm-6 col-md-3">
                      <div class="quick-stats__item bg-amber">
                          <div class="quick-stats__info">
                            <div class="row">
                              <div class="col-md-6 col-sm-6">
                                <b style="font-size:50px;color:white;">{{$jmlevent}}</b>
                              </div>
                              <div class="col-md-6 col-sm-6">
